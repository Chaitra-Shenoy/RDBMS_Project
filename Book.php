<?php
  ...
  $time=$_POST['time'];
  $date=$_POST['date'];
  $sql="UPDATE TABLE_INFO SET TABLES_BOOKED=TABLES_BOOKED+1 WHERE RNAME='$resn' and TABLE_NAME='$type' ";
  $sql1="insert into cust_info (CNAME,CNUMBER,CTIME,CDATE,RNAME) values ('$name','$cn','$time','$date','$resn')";
...
<select class="mt-2" NAME="search">
  ...
  <option value="DIESEL CAFE">DIESEL CAFE</option>
  <option value="THYME RESTRO">THYME RESTRO</option>
  <option value="PALLKHI RESTAURANT">PALLKHI RESTAURANT</option>
  <option value="MACHALI">MACHALI</option>
  <option value="SAGAR RATNA">SAGAR RATNA</option>
  <option value="SIZZLER RANCH">SIZZLER RANCH</option>
  <option value="KABAB STUDIO">KABAB STUDIO</option>
  <option value="BRICK HOUSE">BRICK HOUSE</option>
  <option value="KHASAK">KHASAK</option>
  <option value="AURFILA CONTINENTAL">AURFILA CONTINENTAL</option>
  <option value="HAO MING">HAO MING</option>
  <option value="FISH GARAGE">FISH GARAGE</option>
  <option value="ONESTA">ONESTA</option>
  <option value="TRATTORIA">TRATTORIA</option>
  <option value="PUNJAB DA PIND">PUNJAB DA PIND</option>
  <option value="ONYX AIR LOUNGE">ONYX AIR LOUNGE</option>
  ...
  <option value="SNACK SHACK">SNACK SHACK</option>
  <option value="BASIL CAFE">BASIL CAFE</option>
  <option value="HAKUNA MATATA">HAKUNA MATATA</option>
  <option value="ZZA RESTRO">ZZA RESTRO</option>
  <option value="EYE OF THE TIGER">EYE OF THE TIGER</option>
  <option value="COAST ASIA">COAST ASIA</option>
  ...
  <option value="CAFE DE ARTE">CAFE DE ARTE</option>
  <option value="GRUB MONKEYS">GRUB MONKEYS</option>
  <option value="MEXICAN BURRITO">MEXICAN BURITO</option>
  <option value="GINGER GARLIC">GINGER GARLIC</option>
  ...
  <option value="THAMBOOLAM">THAMBOOLAM</option>
  <option value="GOKUL KRISHNA">GOKUL KRISHNA</option>
  <option value="MITRA SAMAJ">MITRA SAMAJ</option>
  <optgroup label="BANGALORE"></optgroup>
  <option value="EDO JAPANESE RESTRO">EDO JAPANESE RESTRO</option>
  <option value="BLACK PEARL">BLACK PEARL</option>
  <option value="KARAVALI">KARAVALI</option>
  <option value="TRUFFLES">TRUFFLES</option>
  <option value="RAJ PAVILLION">RAJ PAVILLION</option>
  <option value="JW KITCHEN">JW KITCHEN</option>
  <option value="THE CUBBON PAVILLION">THE CUBBON PAVILLION</option>
  <option value="FARZI CAFE">FARZI CAFE</option>
  <option value="CAPRESE">CAPRESE</option>
  <option value="SHANG PALACE">SHANG PALACE</option>
